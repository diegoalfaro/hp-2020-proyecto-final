<template>
    <crud
        ...
        :fields="fields"
        :form="form"
        :create="createRepairProduct"
        :update="updateRepairProduct"
        :delete="deleteRepairProduct"
        :readonly="readonly"
    />
</template>

<script>
import RepairProductForm from "../forms/RepairProductForm.vue";
